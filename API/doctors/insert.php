...
$stmt1 = $con->prepare("INSERT INTO `users`(`email`,`name`,`password`,`phone`,`address`,`gender`,`age`,`image`,`is_doctor`,created_at ) VALUES (?,?,?,?,?,?,?,'yes',NOW())");
$stmt1->execute(array($email,   $name, $password, $phone, $address, $gender, $age, $image));
